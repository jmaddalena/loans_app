...
source("shiny/source_iter.R")
```

# Loan Info Lists

```{r}
loans_as_is <- conduct_schedule_analysis(x, max_mo_pay = NA, int_tiebreak = "higher balance")
        
loans_pay600 <- conduct_schedule_analysis(x, max_mo_pay = 650, int_tiebreak = "higher balance")


ggplot(loans_pay600, aes(x = month, y = new_balance, fill = name)) + 
  geom_bar(stat = "identity") +
  labs("Total loan balance")
